...
get_header();
	...
	// Theme Options
	$portio_sidebar_position = cs_get_option( 'service_sidebar_position' );
	$portio_single_comment = cs_get_option( 'service_comment_form' );
	...
	if ( $portio_sidebar_position === 'sidebar-hide' ) {
		$portio_layout_class = 'col-md-12 col col-xs-12';
		$portio_sidebar_class = 'hide-sidebar';
	} elseif ( $portio_sidebar_position === 'sidebar-left' ) {
		$portio_layout_class = 'col col-lg-8 col-lg-push-4';
		$portio_sidebar_class = 'left-sidebar';
	} else {
		$portio_layout_class = 'col-lg-8';
		$portio_sidebar_class = 'right-sidebar';
	} ?>
<div class="service-single-section section-padding <?php echo esc_attr( $portio_content_padding .' '. $portio_sidebar_class ); ?>" style="<?php echo esc_attr( $portio_custom_padding ); ?>">
	<div class="container">
		<div class="row">
