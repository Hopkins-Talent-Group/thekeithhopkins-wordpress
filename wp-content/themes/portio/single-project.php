...
// Theme Options
$portio_sidebar_position = cs_get_option('project_sidebar_position');
$portio_single_comment = cs_get_option('project_comment_form');
$portio_sidebar_position = $portio_sidebar_position ? $portio_sidebar_position : 'sidebar-hide';
// Sidebar Position
if ($portio_sidebar_position === 'sidebar-hide') {
	$portio_layout_class = 'col-lg-12';
	$portio_sidebar_class = 'hide-sidebar';
} elseif ($portio_sidebar_position === 'sidebar-left') {
	$portio_layout_class = 'col col-lg-8 order-lg-2';
	$portio_sidebar_class = 'left-sidebar';
} else {
	$portio_layout_class = 'col col-lg-8';
	$portio_sidebar_class = 'right-sidebar';
} ?>
<div class="project-single-section section-padding <?php echo esc_attr($portio_content_padding . ' ' . $portio_sidebar_class); ?>" style="<?php echo esc_attr($portio_custom_padding); ?>">
	<div class="container">
		<div class="row">
			<div class="<?php echo esc_attr($portio_layout_class); ?>">
