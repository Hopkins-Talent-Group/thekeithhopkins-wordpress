/*
 * All Admin Related Scripts in this Portio Theme
...
"use strict";
  ...
  /*---------------------------------------------------------------*/
   function portio_gutenberg_toggle_metaboxes() {
  ...
  function portio_toggle_metaboxes() {
  ...
  $(document).ready(function() {
      portio_gutenberg_toggle_metaboxes();
      portio_toggle_metaboxes();
    $('#post-formats-select input[type="radio"]').on('click', portio_toggle_metaboxes);
  });
