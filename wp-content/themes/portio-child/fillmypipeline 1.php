    ...
    <div class="container" style="padding: 60px 15px 80px;">
        ...
        <div class="row" id="lead-form">
            <div class="col-lg-7 offset-lg-2" style="margin-bottom: 20px;">
                ...
                <p style="color: #666; margin-bottom: 30px;">Fill this out and we'll show you how many leads you're leaving on the table.</p>
                ...
                <form method="POST" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" style="background: #fff; border: 1px solid #e9ecef; padding: 40px; border-radius: 12px; box-shadow: 0 8px 30px rgba(0,0,0,0.06);">
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <input type="text" name="fmp_name" required style="width:100%; padding:14px; border:1px solid #ddd; border-radius:8px; font-size:1rem;">
                    </div>

                    <div style="margin-bottom: 20px;">
                        <label style="display:block; font-weight:600; margin-bottom:8px;">Email *</label>
                        <input type="email" name="fmp_email" required style="width:100%; padding:14px; border:1px solid #ddd; border-radius:8px; font-size:1rem;">
                    </div>

                    <div style="margin-bottom: 20px;">
                        <label style="display:block; font-weight:600; margin-bottom:8px;">Phone</label>
                        <input type="tel" name="fmp_phone" style="width:100%; padding:14px; border:1px solid #ddd; border-radius:8px; font-size:1rem;">
                    </div>

                    <div style="margin-bottom: 25px;">
                        <label style="display:block; font-weight:600; margin-bottom:8px;">Business Type</label>
                        <select name="fmp_business" style="width:100%; padding:14px; border:1px solid #ddd; border-radius:8px; font-size:1rem; background:#fff;">
                    ...
                    <div style="margin-bottom: 25px;">
                        <label style="display:block; font-weight:600; margin-bottom:8px;">Tell us about your business</label>
                        <textarea name="fmp_message" rows="4" style="width:100%; padding:14px; border:1px solid #ddd; border-radius:8px; font-size:1rem; resize:vertical;"></textarea>
                    </div>
