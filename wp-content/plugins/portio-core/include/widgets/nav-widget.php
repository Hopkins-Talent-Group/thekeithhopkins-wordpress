...
class portio_navigation_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      '-navigation-widget',
      GRAFCO_THEME_NAME_PLUGIN . esc_html__( ': Navigation', 'portio' ),
      array(
        'classname'   => 'link-widget',
        'description' => GRAFCO_THEME_NAME_PLUGIN . esc_html__( ' widget that displays navigations list.', 'portio' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $nav_list_field = array(
      ...
      'type' => 'select',
      'options' => 'menus',
      'title' => esc_html__( 'Select Menu List :', 'portio' ),
    );
    ...
    $nav_child_field = array(
      ...
      'title' => esc_html__( 'Display Menu Children :', 'portio' ),
      'help' => esc_html__( 'This only shows first level of child menus.', 'portio' ),
    );
...
add_action( 'widgets_init', function() { register_widget( "portio_navigation_widget" ); } );
