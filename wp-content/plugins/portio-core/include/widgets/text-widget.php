 ...
 */
class portio_text_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      'text-widget',
      GRAFCO_THEME_NAME_PLUGIN . esc_html__( ': Text Widget', 'portio' ),
      array(
        'classname'   => 'text-widget',
        'description' => GRAFCO_THEME_NAME_PLUGIN . esc_html__( ' widget that displays contents.', 'portio' )
      )
    );
  }
...
add_action( 'widgets_init', function() { register_widget( "portio_text_widget" ); } );