 ...
 */
class portio_causes_posts extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      '-causes-blog',
      GRAFCO_THEME_NAME_PLUGIN . esc_html__( ': Causes Posts', 'portio' ),
      array(
        'classname'   => 'recent-post-widget',
        'description' => GRAFCO_THEME_NAME_PLUGIN . esc_html__( ' widget that displays causes posts.', 'portio' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $instance   = wp_parse_args( $instance, array(
      'title'    => esc_html__( 'Causes Posts', 'portio' ),
      'ptypes'   => 'post',
      'limit'    => '3',
      'date'     => true,
      'category' => '',
...
add_action( 'widgets_init', function() { register_widget( "portio_causes_posts" ); } );