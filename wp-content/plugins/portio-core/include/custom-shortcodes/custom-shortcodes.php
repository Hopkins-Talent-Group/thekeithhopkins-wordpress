<?php
/* Spacer */
function portio_spacer_function($atts, $content = true) {
...
add_shortcode("portio_spacer", "portio_spacer_function");

/* Social Icons */
function portio_socials_function($atts, $content = true) {
  extract(shortcode_atts(array(
    "social_select" => '',
    "custom_class" => '',
    "section_title" => '',
  ...
  if ( $icon_color || $icon_size ) {
    ...
    $inline_style .= ( $icon_size ) ? 'font-size:'. portio_core_check_px($icon_size) .';' : '';
    $inline_style .= '}';
  }
...
add_shortcode("portio_socials", "portio_socials_function");

/* Social Icon */
function portio_social_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_link" => '',
      "social_icon" => '',
      "target_tab" => ''
...
add_shortcode("portio_social", "portio_social_function");



/* Simple Images */
function portio_image_lists_function($atts, $content = true) {
  extract(shortcode_atts(array(
    "custom_class" => '',
  ), $atts));
...
add_shortcode("portio_image_lists", "portio_image_lists_function");

/* Simple Image */
function portio_image_list_function($atts, $content = NULL) {
  extract(shortcode_atts(array(
    "get_image" => '',
    "link" => '',
    "open_tab" => ''
...
add_shortcode("portio_image_list", "portio_image_list_function");

/* Simple Underline Link */
function portio_simple_link_function($atts, $content = NULL) {
  extract(shortcode_atts(array(
    "link_style" => '',
    "link_icon" => '',
    "link_text" => '',
  ...
  if ( $text_color || $text_size ) {
    ...
    $inline_style .= ( $text_size ) ? 'font-size:'. portio_core_check_px($text_size) .';' : '';
    $inline_style .= '}';
  }
  if ( $text_hover_color ) {
...
add_shortcode("portio_simple_link", "portio_simple_link_function");


/* Top bar info */
function portio_widget_topbars_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
   ), $atts));
...
add_shortcode("portio_widget_topbars", "portio_widget_topbars_functions");

/* Top bar info */
function portio_widget_topbar_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "info_icon" => '',
      "subtitle" => '',
      "title" => '',
...
add_shortcode("portio_widget_topbar", "portio_widget_topbar_function");


/*header Social */
function portio_header_socials_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "custom_text" => ''
   ), $atts));
...
add_shortcode("portio_header_socials", "portio_header_socials_function");

/* Address Info */
function portio_header_social_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_icon" => '',
      "social_icon_color" => '',
      "social_link" => '',
...
add_shortcode("portio_header_social", "portio_header_social_function");


/*header Middle Info */
function portio_header_middle_infos_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => ''
   ), $atts));
...
add_shortcode("portio_header_middle_infos", "portio_header_middle_infos_function");

/*header Middle Info  */
function portio_header_middle_info_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_icon" => '',
      "social_icon_color" => '',
      "address_text" => '',
...
add_shortcode("portio_header_middle_info", "portio_header_middle_info_function");
/*header Middle Info End */

/* Address Infos */
function portio_address_infos_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => ''
   ), $atts));
...
add_shortcode("portio_address_infos", "portio_address_infos_function");

/* Address Info */
function portio_address_info_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "address_style" => '',
      "info_icon" => '',
      "info_icon_color" => '',
...
add_shortcode("portio_address_info", "portio_address_info_function");

/* Useful Links */
function portio_useful_links_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "column_width" => '',
      "custom_class" => ''
   ), $atts));
...
add_shortcode("portio_useful_links", "portio_useful_links_function");

/* Useful Link */
function portio_useful_link_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "target_tab" => '',
      "title_link" => '',
      "link_title" => ''
...
add_shortcode("portio_useful_link", "portio_useful_link_function");

/* Footer Menus */
function portio_footer_menus_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => ''
   ), $atts));
...
add_shortcode("portio_footer_menus", "portio_footer_menus_function");

/* Footer Menu */
function portio_footer_menu_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "menu_title" => '',
      "menu_link" => '',
      "target_tab" => ''
...
add_shortcode("portio_footer_menu", "portio_footer_menu_function");

/* footer contact */
function portio_footer_contacts_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "contact_title" => '',
   ), $atts));
...
add_shortcode("portio_footer_contact_infos", "portio_footer_contacts_functions");

/*  footer contact  */
function portio_footer_contacts_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "icon" => '',
      "item_title" => '',
   ), $atts));
...
add_shortcode("portio_footer_contact_info", "portio_footer_contacts_function");


 /* footer Address */
function portio_addresss_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
   ), $atts));
...
add_shortcode("portio_footer_address_item", "portio_addresss_functions");


 /* footer Addresss */
function portio_address_functions($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "item" => '',
   ), $atts));
...
add_shortcode("portio_footer_address_items", "portio_address_functions");

/* Blockquote */
function portio_blockquote_function($atts, $content = true) {
  extract(shortcode_atts(array(
    "blockquote_style" => '',
    "text_size" => '',
    "custom_class" => '',
...
add_shortcode("portio_blockquote", "portio_blockquote_function");


/* Footer Logo Items */
function portio_widget_footer_infos_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "footer_logo" => '',
      "desc" => '',
...
add_shortcode("footer_infos", "portio_widget_footer_infos_functions");


/* Footer Logo Item */
function portio_widget_footer_infos_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_icon" => '',
      "social_link" => '',
   ), $atts));
...
add_shortcode("footer_info", "portio_widget_footer_infos_function");


/* Contact Infos */
function portio_widget_contact_infos_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "heading_title" => ''
   ), $atts));
...
add_shortcode("portio_widget_contact_infos", "portio_widget_contact_infos_functions");


/* Widget Contact Info */
function portio_widget_contact_infos_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "title" => '',
      "number" => '',
...
add_shortcode("portio_widget_contact_info", "portio_widget_contact_infos_function");


/* Widget Contact Info */
function portio_widget_testimonial_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "title" => '',
      "subtitle" => '',
...
add_shortcode("portio_widget_testimonial", "portio_widget_testimonial_function");


/* Service Contact Widgets */
function portio_service_widget_contacts_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "contact_title" => '',
   ), $atts));
...
add_shortcode("portio_service_widget_contacts", "portio_service_widget_contacts_functions");

/* Service Contact Widget */
function portio_service_widget_contact_functions($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "info" => '',
   ), $atts));
...
add_shortcode("portio_service_widget_contact", "portio_service_widget_contact_functions");

/* Download Widgets */
function portio_download_widgets_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
   ), $atts));
...
add_shortcode("portio_download_widgets", "portio_download_widgets_functions");

/* Download Widget */
function portio_download_widget_functions($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "download_icon" => '',
      "title" => '',
      "link" => '',
...
add_shortcode("portio_download_widget", "portio_download_widget_functions");

/* Current Year - Shortcode */
if( ! function_exists( 'portio_current_year' ) ) {
  function portio_current_year() {
    return date('Y');
  }
  add_shortcode( 'portio_current_year', 'portio_current_year' );
}

/* Get Home Page URL - Via Shortcode */
if( ! function_exists( 'portio_home_url' ) ) {
  function portio_home_url() {
    return esc_url( home_url( '/' ) );
  }
  add_shortcode( 'portio_home_url', 'portio_home_url' );
}


/* About Widget */
function portio_widget_about_block_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "title" => '',
      "image_url" => '',
...
add_shortcode("portio_about_widget", "portio_widget_about_block_function");