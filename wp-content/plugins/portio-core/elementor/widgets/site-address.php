...
class Grafco_Address extends Widget_Base{
	...
	*/
	public function get_title(){
		return esc_html__( 'Address Info', 'portio-core' );
	}
	...
	*/
	protected function register_controls(){
		...
		$this->add_control(
			'address_desc',
			[
				'label' => esc_html__( 'Address Text', 'portio-core' ),
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Call: +88 659 789 874', 'portio-core' ),
				'placeholder' => esc_html__( 'Type title text here', 'portio-core' ),
				'label_block' => true,
			]
		);
...
Plugin::instance()->widgets_manager->register_widget_type( new Grafco_Address() );