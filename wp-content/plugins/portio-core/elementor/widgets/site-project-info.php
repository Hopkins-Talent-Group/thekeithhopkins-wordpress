<?php
/*
 * Elementor Portio ProjectItem Widget
...
class Site_ProjectItem extends Widget_Base{
	...
	*/
	public function get_title(){
		return esc_html__( 'Project Info', 'portio-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Portio ProjectItem widget depended on.
	...
	*/
	...
	/**
	 * Register Portio ProjectItem widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_ProjectItem',
			[
				'label' => esc_html__( 'ProjectItem Options', 'portio-core' ),
			]
		);
		$this->add_control(
			'section_title',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Feature Icons', 'portio-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'single_feature_title' => esc_html__( 'Feature', 'portio-core' ),
					],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Info', 'portio-core' ),
