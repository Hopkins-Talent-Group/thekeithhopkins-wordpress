<?php
/*
 * Elementor Portio Client Widget
...
class Site_Client extends Widget_Base
{
	...
	{
		return esc_html__('Client', 'portio-core');
	}
	...
	/**
	 * Retrieve the list of scripts the Portio Client widget depended on.
	...
	/**
	 * Register Portio Client widget controls.
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_client',
			[
				'label' => esc_html__('Client Options', 'portio-core'),
			]
		);
		$this->add_control(
			'client_style',
			[
				'label' => esc_html__('Client Style', 'portio-core'),
				...
				'default' => 'style-one',
				'description' => esc_html__('Select your Client style.', 'portio-core'),
			]
		);
		$this->add_control(
			'section_title',
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => __('https://your-link.com', 'portio-core'),
				'label_block' => true,
				'show_external' => true,
				'default' => [
					'url' => '',
		...
		$this->add_control(
			'clientLogos_groups',
			[
				'label' => esc_html__('Client Logos', 'portio-core'),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'client_title' => esc_html__('Client', 'portio-core'),
					],
...
?>
		<div class="sponsor-section">
			<div class="container">
				...
				<div class="client-wrap sponsor-slider">
