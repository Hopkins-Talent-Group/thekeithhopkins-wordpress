<?php
/*
 * Elementor Portio Search Widget
...
class Grafco_Search extends Widget_Base{
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Portio Search widget depended on.
	...
	*/
	...
	/**
	 * Register Portio Search widget controls.
...
Plugin::instance()->widgets_manager->register( new Grafco_Search() );