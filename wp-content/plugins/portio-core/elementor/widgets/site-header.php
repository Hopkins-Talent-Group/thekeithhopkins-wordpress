<?php
/*
 * Elementor Portio Header Widget
...
class Site_Header extends Widget_Base
{
	...
	{
		return esc_html__('Header', 'portio-core');
	}
	...
	/**
	 * Retrieve the list of scripts the Portio Header widget depended on.
	...
	/**
	 * Register Portio Header widget controls.
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_Header',
			[
				'label' => esc_html__('Header Options', 'portio-core'),
			]
		);
		$this->add_control(
			'navigation_style',
			[
				'label' => esc_html__('Navigation', 'portio-core'),
				...
				'default' => 'style-one',
				'description' => esc_html__('Select your navigation style.', 'portio-core'),
			]
		);
		...
		if (!empty($menus)) {
			$this->add_control(
				'menu',
				[
					'label' => __('Menu', 'portio'),
					'type' => Controls_Manager::SELECT,
					'options' => $menus,
					'default' => array_keys($menus)[0],
					'save_default' => true,
					'separator' => 'after',
					'description' => sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'portio'), admin_url('nav-menus.php')),
				]
			);
		} else {
			$this->add_control(
				...
				[
					...
					'raw' => '<strong>' . __('There are no menus in your site.', 'portio') . '</strong><br>' . sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'portio'), admin_url('nav-menus.php?action=edit&menu=0')),
					'separator' => 'after',
					'content_classes' => 'portio-panel-alert portio-panel-alert-info',
				]
			);
		}
		$this->add_control(
			'header_logo',
			[
				'label' => esc_html__('Logo Image', 'portio-core'),
		...
		$this->add_control(
			'header_search',
			[
				'label' => esc_html__('Search', 'portio-core'),
		...
		$this->add_control(
			'header_cart',
			[
				'label' => esc_html__('Cart', 'portio-core'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__('Show', 'portio-core'),
				'label_off' => esc_html__('Hide', 'portio-core'),
				'return_value' => 'true',
		...
		$this->start_controls_section(
			'portio_section_style_main-menu',
			[
				'label' => __('Main Menu', 'portio'),
		...
		$this->add_responsive_control(
			...
			[
				'label' => __('Main Menu Height', 'portio'),
		...
		$this->start_controls_tab(
			'portio_tab_menu_item_normal',
			[
				'label' => __('Normal', 'portio'),
			]
		);

		$this->add_control(
			'portio_color_menu_bg_item',
			[
				'label' => __('Background Color', 'portio'),
		...
		$this->add_control(
			'portio_color_menu_item',
			[
				'label' => __('Text Color', 'portio'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => __('Horizontal Padding', 'portio'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->add_responsive_control(
			...
			[
				'label' => __('Vertical Padding', 'portio'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->add_control(
			...
			[
				'raw' => __('On desktop, this will affect the submenu. On mobile, this will affect the entire menu.', 'portio'),
				'type' => Controls_Manager::RAW_HTML,
				'content_classes' => 'portio-descriptor',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'description' => esc_html__('Button Color', 'portio-core'),
				'types' => ['gradient'],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Search & Cart', 'portio-core'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
	...
	protected function render()
	{
		...
		if ($navigation_style == 'style-one') {
			...
			$logo_col = 'col-lg-5';
			$header_container = 'container-fluid';
			$header_right_col = 'col-lg-3 d-lg-none d-block';
		} elseif ($navigation_style == 'style-three') {
			$nav_style = 'wpo-site-header-s3';
			$logo_col = 'col-lg-5';
			$header_container = 'container-fluid';
			$header_right_col = 'col-lg-3 d-lg-none d-block';
		} else {
			$nav_style = 'wpo-site-header-s11';
			$logo_col = 'col-lg-3';
			$header_container = 'container-fluid';
									...
									<div class="mini-cart">
										...
										<div class="mini-cart-content">
											...
											<div class="mini-cart-title">
												<p><?php echo esc_html__('Shopping Cart', 'portio'); ?></p>
											</div>
