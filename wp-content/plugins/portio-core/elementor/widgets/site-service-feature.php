<?php
/*
 * Elementor Portio ServiceItem Widget
...
class Site_ServiceItem extends Widget_Base
{
	...
	{
		return esc_html__('Service Feature', 'portio-core');
	}
	...
	/**
	 * Retrieve the list of scripts the Portio ServiceItem widget depended on.
	...
	*/
	...
	/**
	 * Register Portio ServiceItem widget controls.
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_ServiceItem',
			[
				'label' => esc_html__('ServiceItem Options', 'portio-core'),
			]
		);
