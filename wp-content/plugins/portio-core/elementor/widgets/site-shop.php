<?php
/*
 * Elementor Portio Product Widget
...
class Grafco_Product extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-portio_product';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Product', 'portio-core' );
	}
  ...
  public function get_keywords() {
	...
	/**
	 * Retrieve the list of scripts the Portio Product widget depended on.
	...
	*/
	...
	/**
	 * Register Portio Product widget controls.
    ...
    if ( $posts ) {
      ...
      $PostID[ __( 'No ID\'s found', 'portio' ) ] = 0;
		...
		$this->add_control(
			'product_limit',
			[
				'label' => esc_html__( 'Product Limit', 'portio-core' ),
...
Plugin::instance()->widgets_manager->register( new Grafco_Product() );