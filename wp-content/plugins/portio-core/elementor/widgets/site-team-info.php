<?php
/*
 * Elementor portio Team Info Widget
...
class Site_TeamInfo extends Widget_Base
{
	...
	{
		return esc_html__('Team Info', 'portio-core');
	}
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_TeamInfo',
			[
				'label' => esc_html__('Team Info Options', 'portio-core'),
			]
		);
		$this->add_control(
			'section_title',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Team Info', 'portio-core'),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'single_team_title' => esc_html__('Team Info', 'portio-core'),
					],
