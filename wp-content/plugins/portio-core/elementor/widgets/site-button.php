<?php
/*
 * Elementor Portio Button Widget
...
class Grafco_Button extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-portio_button';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Button', 'portio-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Portio Button widget depended on.
	...
	*/
	...
	/**
	 * Register Portio Button widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_Button',
			[
				'label' => __( 'Button Options', 'portio-core' ),
			]
		);
		$this->add_control(
			'btn_style',
			[
				'label' => esc_html__( 'Button Style', 'portio-core' ),
				...
				'default' => 'style-one',
				'description' => esc_html__( 'Select your Button style.', 'portio-core' ),
			]
		);
		$this->add_responsive_control(
			'section_alignment',
			[
				'label' => esc_html__( 'Alignment', 'portio-core' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => esc_html__( 'Left', 'portio-core' ),
						'icon' => 'fa fa-align-left',
					],
					'center' => [
						'title' => esc_html__( 'Center', 'portio-core' ),
						'icon' => 'fa fa-align-center',
					],
					'right' => [
						'title' => esc_html__( 'Right', 'portio-core' ),
...
Plugin::instance()->widgets_manager->register( new Grafco_Button() );