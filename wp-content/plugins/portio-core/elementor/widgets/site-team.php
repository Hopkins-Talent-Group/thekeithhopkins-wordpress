...
class Grafco_Team extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-portio_team';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Team', 'portio-core' );
	}
	...
	protected function register_controls(){
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Type sub title text here', 'portio-core' ),
				'label_block' => true,
			]
		);
		$repeater->add_control(
			'bg_image',
			[
				'label' => esc_html__( 'Team Image', 'portio-core' ),
		...
		$this->add_control(
			'teamItems_groups',
			[
				'label' => esc_html__( 'Team Items', 'portio-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'team_title' => esc_html__( 'Team', 'portio-core' ),
					],
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__('Border szfs', 'portio-core'),
				'types' => [ 'classic', 'gradient', 'video' ],
				'selector' => '{{WRAPPER}} .speaker-single',
			]
		);
		// $this->add_group_control(
...
Plugin::instance()->widgets_manager->register( new Grafco_Team() );