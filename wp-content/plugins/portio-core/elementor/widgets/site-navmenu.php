<?php
/*
 * Elementor Portio Navmenu Widget
...
class Grafco_Navmenu extends Widget_Base{
	...
	*/
	public function get_title(){
		return esc_html__( 'Nav Menu', 'portio-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Portio Navmenu widget depended on.
	...
	*/
	...
	/**
	 * Register Portio Navmenu widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_Navmenu',
			[
				'label' => esc_html__( 'Navmenu Options', 'portio-core' ),
			]
		);
...
Plugin::instance()->widgets_manager->register( new Grafco_Navmenu() );