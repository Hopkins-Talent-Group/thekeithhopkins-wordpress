...
class Grafco_Contactinfo extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-portio_contactinfo';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Contact Info', 'portio-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Portio Contactinfo widget depended on.
	...
	*/
	...
	/**
	 * Register Portio Contactinfo widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_contactinfo',
			[
				'label' => esc_html__( 'Contactinfo Options', 'portio-core' ),
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Info Box', 'portio-core' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Icon BG', 'portio-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
	...
	// Content
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Active', 'portio-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'active_bg_color',
			[
				'label' => esc_html__( 'Active Background', 'portio-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'active_border_color',
			[
				'label' => esc_html__( 'Active Border', 'portio-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
...
Plugin::instance()->widgets_manager->register_widget_type( new Grafco_Contactinfo() );