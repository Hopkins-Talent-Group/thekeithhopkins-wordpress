...
class Grafco_brand extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-portio_brand';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Site Logo', 'portio-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Portio brand widget depended on.
	...
	*/
	...
	/**
	 * Register Portio brand widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_brand',
			[
				'label' => esc_html__( 'Brand Options', 'portio-core' ),
			]
		);
		$this->add_control(
			'brand_logo',
			[
				'label' => esc_html__( 'Site Logo', 'portio-core' ),
...
Plugin::instance()->widgets_manager->register( new Grafco_brand() );